...
export class PaginationComponent implements OnInit, OnChanges {
    ...
    setPage(page: number) {
        ...
        this.pager = this.paginationService.getPager(this._totalCount, page, this.pageSize);
    ...
    setPageSize(event: any) {
        this.pager = this.paginationService.getPager(this._totalCount, this.currentPage, event.value);
