export const applicationName = "ky-ler-wallet-client";
...
export const IGNORE_AUTH_ENDPOINTS = [
    /api\/authenticate\/login/i,
    /api\/public/i,
    /api\/ClientLog/i,
    /api\/register/i,
    /api\/email\/confirmemailchange/i,
];

export const IGNORE_REFRESH_ENDPOINTS = [/api\/logout/, /api\/authenticate\/refresh/];
